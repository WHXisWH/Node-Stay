...
> デプロイ手順（Render + Vercel）→ **[docs/DEPLOY_RENDER_VERCEL.md](docs/DEPLOY_RENDER_VERCEL.md)**
...
└── docs/
    ...
    └── DEPLOY_RENDER_VERCEL.md      # Render + Vercel デプロイ手順
```
...
NEXT_PUBLIC_MACHINE_REGISTRY_ADDRESS=0x224C501d39E70673eC438625bF2728e08e7711A8
NEXT_PUBLIC_SETTLEMENT_ADDRESS=0x3ab2F7f7Ad6E3654C59175859c2D9e2B122F7dA9
NEXT_PUBLIC_COMPUTE_RIGHT_ADDRESS=0xb14c3d3A6Ca41Fa6f41ceD756213AA7135c7621d
NEXT_PUBLIC_JPYC_TOKEN_ADDRESS=0x807Cdfe8893E0bC125DBcA013147068C021ef759

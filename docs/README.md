...
このディレクトリには、実装アーキテクチャ資料とプロダクト設計資料（ドラフト含む）を格納しています。  
現在の実装追従の一次参照は `ARCHITECTURE.md` と `README.md` です。
...
- 実装変更時は `ARCHITECTURE.md` とルート `README.md` を優先更新してください。
- 既存の設計資料はドラフトを含むため、実装との差分がある場合は実装側を正とします。
